...
using UserRole = AfricanFarmersCommodities.Domain.UserRole;
...
namespace AfricanFarmersCommodities.Web.IdentityServices
{
    ...
    public class UserService : IUserService
    {
        ...
        public UserService(AppSettingsConfigurations appSettings, IRoleService roleService, AesExternalProcedures passwordEncryptor, AfricanFarmerCommoditiesUnitOfWork unitOfWork)
        {

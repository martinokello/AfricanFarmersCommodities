...
namespace AfricanFarmerCommodities.Web.IdentityServices
{
    ...
    public class RoleService:IRoleService
    {
        ...
        public RoleService(AesExternalProcedures passwordEncryptor, AfricanFarmerCommoditiesUnitOfWork unitOfWork)
        {

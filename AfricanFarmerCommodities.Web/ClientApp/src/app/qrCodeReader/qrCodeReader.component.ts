...
import { IUserStatus, AfricanFarmerCommoditiesService, IUserDetail } from '../../services/africanFarmerCommoditiesService';
...
export class QrCodeComponent implements OnInit {
  ...
  submitScanToVerify() {
    let results: Observable<any> = this.africanFarmerCommoditiesService.VerifyQrcodeScan(this.userDetails);
    results.map((res) => {
  ...
  ngOnInit() {
    this.userDetails = AfricanFarmerCommoditiesService.userDetails;
  }

...
export class ActiveCrudOperationsComponent implements AfterContentInit {
  ...
  ngAfterContentInit() {
    let elNodeList: NodeListOf<HTMLElement> = document.querySelectorAll('div#createFarmerEcosystem ul.nav-tabs li a') as NodeListOf<HTMLElement>;
    ...
    let ddAnchNodeList: NodeListOf<HTMLElement> = document.querySelectorAll('div#createFarmerEcosystem ul.nav-tabs ul.dropdown-menu li a') as NodeListOf<HTMLElement>;

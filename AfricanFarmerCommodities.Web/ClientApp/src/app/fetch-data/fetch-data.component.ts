...
import { AfricanFarmerCommoditiesService, ILocationWeather } from '../../services/africanFarmerCommoditiesService';
...
export class FetchDataComponent {
  ...
  constructor(private africanFarmerCommoditiesService: AfricanFarmerCommoditiesService) {
  }
  SearchLocationWeather(): ILocationWeather {
    ...
    let weatherForcast: Observable<ILocationWeather> = this.africanFarmerCommoditiesService.GetSearchLocationWeather(locationElems[0], locationElems[1]);

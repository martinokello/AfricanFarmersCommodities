...
namespace AfricanFarmersCommodities.Services.EmailServices.Concretes
{
    public class EmailService : AfricanFarmersCommodities.Services.EmailServices.Interfaces.IMailService
    {
